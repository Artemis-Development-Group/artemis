...
To make changes to files not in the `/r2/r2/public/static` folder, you will need to rebuild. Run `sudo make` in `/r2/` after you've made your modifications, and then run `sudo artemis-restart`.
