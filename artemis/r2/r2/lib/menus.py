...
menu =   MenuHandler(hot          = _('hot'),
                     ...
                     community_settings = _("branch settings"),
...
class BranchButton(NavButton):
    from r2.models.branch import Frontpage, Mod, All, Random, RandomSubscription
    ...
    # TRANSLATORS: This refers to the user's front page
                      ...
                      All: N_("all"),
                      Random: N_("random"),
    # TRANSLATORS: Gold feature, "myrandom", a random branch from your subscriptions
...
class CommentSortMenu(SortMenu):
    ...
    # that is, do not check the branch for a suggested sort, either.
...
class BranchSearchSortMenu(SortMenu):
    """Sort menu for branch search pages."""
    _default = 'relevance'
