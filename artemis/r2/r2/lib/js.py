...
class LocalizedModule(Module):
    ...
    def build(self, minifier):
        ...
        with open(self.destination_path) as f:
            artemis_source = f.read()

        localized_appendices = self.localized_appendices
        msgids = extract_javascript_msgids(artemis_source)
        if msgids:
...
module["artemis-embed-base"] = Module("artemis-embed-base.js",
    "lib/es5-shim.js",
    "lib/json2.js",
    "base.js",
    "uuid.js",
...
module["artemis-embed"] = Module("artemis-embed.js",
    module["artemis-embed-base"],
    "embed/embed.js",
)
...
module["artemis-init-base"] = LocalizedModule("artemis-init-base.js",
    "lib/modernizr.js",
    "lib/json2.js",
...
module["artemis-init-legacy"] = LocalizedModule("artemis-init-legacy.js",
    "lib/html5shiv.js",
    "lib/jquery-1.11.1.js",
    "lib/es5-shim.js",
    "lib/es5-sham.js",
    module["artemis-init-base"],
    wrap=catch_errors,
)

module["artemis-init"] = LocalizedModule("artemis-init.js",
    "lib/jquery-2.1.1.js",
    "lib/es5-shim.js",
    module["artemis-init-base"],
    wrap=catch_errors,
...
module["artemis"] = LocalizedModule("artemis.js",
    "lib/jquery.url.js",
    ...
    wrap=catch_errors,
    filter_module=module["artemis-init-base"],
)

module["modtools"] = Module("modtools.js",
    "errors.js",
    "models/validators.js",
    "models/branch-rule.js",
    "edit-branch-rules.js",
    wrap=catch_errors,
)
...
# browsers that choke on artemis.js
