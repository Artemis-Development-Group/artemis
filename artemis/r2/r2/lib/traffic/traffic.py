...
from r2.models.traffic import (SitewidePageviews, PageviewsByBranch,
        PageviewsByBranchAndPath, PageviewsByLanguage,
...
traffic_categories = (SitewidePageviews, PageviewsByBranch,
                      PageviewsByBranchAndPath, PageviewsByLanguage,
                      ClickthroughsByCodename, TargetedClickthroughsByCodename,
                      AdImpressionsByCodename, TargetedImpressionsByCodename)
...
traffic_subdirectories = {
    ...
    PageviewsByBranch: 'branch',
    PageviewsByBranchAndPath: 'srpath',
...
def _name_to_kw(category_cls, name):
    ...
    def target_split(name):
        ...
        Name is (link,campaign-branch) where link and campaign are
        thing fullnames. campaign and branch are each optional, so
        ...
        if not target_info:
            ...
            campaign_codename, branch = target_info.split('-', 1)
    ...
    d = {SitewidePageviews: lambda n: {},
         PageviewsByBranch: lambda n: {'branch': n},
         PageviewsByBranchAndPath: lambda n: {'srpath': n},
