...
class RavenErrorReporter(Reporter):
    ...
    @classmethod
    def add_artemis_context(cls, client):
        artemis_context = {
            "language": c.lang,
        ...
        if c.site:
            artemis_context["branch"] = c.site.name

        client.extra_context(artemis_context)
    ...
    def get_raven_client(cls):
        app_path_prefixes = [
            "r2",
            "artemis_",  # plugins such as 'artemis_liveupdate'
    ...
    def capture_exception(cls, exc_info=None):
        ...
        if g.running_as_script:
            ...
            cls.add_artemis_context(client)
