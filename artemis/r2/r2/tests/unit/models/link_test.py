...
class TestSubmit(unittest.TestCase):
    def setUp(self):
        from r2.models import (
            ...
            BranchsActiveForFrontPage,
        )

        LinksByAccount.add_link = MagicMock()
        BranchParticipationByAccount.mark_participated = MagicMock()
        BranchsActiveForFrontPage.mark_new_post = MagicMock()

        self.links_by_url_add_link = MagicMock()
        LinksByUrlAndBranch.add_link = self.links_by_url_add_link
        self.links_by_url_remove_link = MagicMock()
        LinksByUrlAndBranch.remove_link = self.links_by_url_remove_link
