...
class TestThingReadCaching(ArtemisTestCase):
    def setUp(self):
...
class TestThingWrite(ArtemisTestCase):
    def setUp(self):
        self.lock = FakeLock()
        self.thing_id = 333
...
class TestThingIncr(ArtemisTestCase):
    def setUp(self):
        self.lock = FakeLock()
        self.thing_id = 333
...
class TestThingWriteConflict(ArtemisTestCase):
    def setUp(self):
        self.lock = FakeLock()
        self.thing_id = 333
