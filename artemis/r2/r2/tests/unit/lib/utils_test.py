...
class UtilsTest(unittest.TestCase):
    ...
    def test_extract_subdomain(self):
        ...
        self.assertEquals(
            utils.extract_subdomain('beta.artemis.local:8000', 'artemis.local'),
            'beta')
    ...
    def test_sanitize_url(self):
        ...
        self.assertEquals(
            utils.sanitize_url('https://github.com/artemis/artemis/pull/1302'),
            'https://github.com/artemis/artemis/pull/1302'
        )
...
class TestUrlToThing(unittest.TestCase):
    ...
    def test_branch_noslash(self):
        with patch('r2.models.Branch') as MockBranch:
            MockBranch._by_name.return_value = s.Branch
            self.assertEqual(
                utils.url_to_thing('http://artemis.local/r/pics'),
                s.Branch,
            )
    ...
    def test_frontpage(self):
        self.assertEqual(
            utils.url_to_thing('http://artemis.local/'),
            None,
        )
