...
class TestEventCollector(ArtemisTestCase):
        ...
        self.amqp.assert_event_item(
            dict(
                ...
                payload={
                    ...
                    'sr_id': initial_vote.thing.branch_slow._id,
                    'sr_name': initial_vote.thing.branch_slow.name,
        ...
        self.amqp.assert_event_item(
            dict(
                ...
                payload={
                    ...
                    'sr_id': upvote.thing.branch_slow._id,
                    'sr_name': upvote.thing.branch_slow.name,
        ...
        self.amqp.assert_event_item(
            dict(
                ...
                payload={
                    ...
                    'sr_id': new_link.branch_slow._id,
                    'sr_name': new_link.branch_slow.name,
    ...
    def test_mod_event(self):
        ...
        request.ip = "1.2.3.4"
        g.events.mod_event(
            modaction, branch, mod, context=context, request=request
        )
    ...
    def test_quarantine_event(self):
        ...
        g.events.quarantine_event(
            event_type, branch, context=context, request=request
        )
        ...
        self.amqp.assert_event_item(
            {
                ...
                "payload": {
                    ...
                    'user_agent': request.user_agent,
                    'user_agent_parsed': request.parsed_agent.to_dict(),
                    'sr_id': message.branch_slow._id,
                    'sr_name': message.branch_slow.name,
                    'oauth2_client_id': context.oauth2_client._id,
                    'oauth2_client_app_type': context.oauth2_client.app_type,
                    'oauth2_client_name': context.oauth2_client.name,
                    'geoip_country': context.location,
