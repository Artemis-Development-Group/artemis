...
from artemis_base import ArtemisController, UnloggedUser
...
class ButtonsController(ArtemisController):
    def get_wrapped_link(self, url, link = None, wrapper = None):
        try:
            ...
            if link:
                ...
                sr = None if isinstance(c.site, FakeBranch) else c.site
                try:
            ...
            # link(s) is/are members of a private artemis
    ...
    def GET_button_demo_page(self):
        ...
        return BoringPage(_("artemis buttons"),
                          show_sidebar = False, 
                          content=ButtonDemoPanel()).render()

    def GET_widget_demo_page(self):
        return BoringPage(_("artemis widget"),
                          show_sidebar = False, 
