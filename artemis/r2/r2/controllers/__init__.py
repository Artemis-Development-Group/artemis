...
_artemis_controllers = {}
_plugin_controllers = {}

def get_controller(name):
    name = name.lower() + 'controller'
    if name in _artemis_controllers:
        return _artemis_controllers[name]
...
def load_controllers():
    ...
    from listingcontroller import BranchesController
    ...
    from listingcontroller import MybranchesController
    ...
    from ipn import ArtemisGiftsController
    from mailgun import MailgunWebhookController

    _artemis_controllers.update((name.lower(), obj) for name, obj in locals().iteritems())
