!function(r) {
  ...
  var LinkExpando = Expando.extend({
    ...
    initialize: function() {
      ...
      if ('branch' in thingData) {
        eventData.branchName = thingData.branch;
      }

      if ('branchFullname' in thingData) {
        eventData.branchFullname = thingData.branchFullname;
      }
    ...
    show: function() {
      ...
      if (!this._expandoEventData.provider) {
        ...
        if ($media.is('iframe')) {
          ...
          this._expandoEventData.provider = 'artemis';
        }
      }
