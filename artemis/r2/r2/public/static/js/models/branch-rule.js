...
!function(models, Backbone, undefined) {
  ...
  var BranchRule = Backbone.Model.extend({
  ...
  var BranchRuleCollection = Backbone.Collection.extend({
    model: BranchRule,
    ...
    initialize: function(models, options) {
      ...
      if (options && options.branchName) {
        this.branchName = options.branchName;
      }
      if (options && options.branchFullname) {
        this.branchFullname = options.branchFullname;
      }
  ...
  r.models.BranchRule = BranchRule;
  r.models.BranchRuleCollection = BranchRuleCollection;
}(r, Backbone);
