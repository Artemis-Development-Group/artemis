r.ui.init = function() {
    // welcome bar
    if ($.cookie('artemis_first')) {
        // save welcome seen state and delete obsolete cookie
        $.cookie('artemis_first', null, {domain: r.config.cur_domain})
    ...
    $('.submit_text').each(function(idx, el) {
        $(el).data('BranchSubmitText', new r.ui.BranchSubmitText({el: el}))
    })
...
r.ui.BranchSubmitText = Backbone.View.extend({
    initialize: function() {
