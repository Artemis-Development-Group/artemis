...
// some modifications have been made to work with artemis; they are commented
// below with a "artemis" prefix.
(function (root, undef) {

  // artemis: *snip* - Jed's miniature underscore.js implementation was removed
      ...
      "locale_data" : {
        "messages" : {
          "" : {
            "domain"       : "messages",
            "lang"         : "en",
            "plural_forms" : "(n != 1);" // artemis: simplified
          }
  ...
  // artemis: this function was modified to bypass the (removed) parser
  ...
  // artemis: *snip* - Jed's fluent API was removed since we won't be using it.
  ...
  // artemis: *snip* - the Jed-supplied sprintf implementation was removed from here

  // artemis: *snip* - Jed's plural forms expression parser was replaced with an
  // eval-based system relying on build-time validity checking

  // artemis: *snip* the npm stuff was removed
  root["Jed"] = Jed;
})(this);
