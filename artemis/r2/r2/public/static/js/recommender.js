...
/**
 * Example usage:
 * // generate recs for people who like book branches
...
r.recommend.RecommendationList = Backbone.Collection.extend({
    ...
    // names of branches for which recommendations are generated
    // (if user likes srNames, he will also like...)
    srNames: [],

    // names of branches that should be excluded from future recs because
...
r.recommend.ExploreItem = Backbone.View.extend({
    events: {
        'click .explore-feedback-dismiss': 'dismissBranch',
        'click a': 'recordClick'
    },  

    dismissBranch: function(ev) {
