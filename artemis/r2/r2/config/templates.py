...
api('branch',     BranchJsonTemplate)
api('labeledmulti',  LabeledMultiJsonTemplate)
api('artemis',        ArtemisJsonTemplate)
...
api('branchtraffic', TrafficJsonTemplate)
...
api('branchestylesheet', StylesheetTemplate)
api('branchestylesheetsource', StylesheetTemplate)
api('createbranch', BranchSettingsTemplate)
