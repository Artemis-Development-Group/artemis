...
from r2.models import Link, Comment, Message, Branch, Account
...
_BranchReport = Relation(Account, Branch)
_MessageReport = Relation(Account, Message)
REPORT_RELS = (_LinkReport, _CommentReport, _BranchReport, _MessageReport)
...
_BranchReport._cache_prefix = classmethod(lambda cls: "reportsr:")
