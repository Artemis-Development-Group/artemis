...
class Flair(Relation(Branch, Account)):
    _cache = g.thingcache
...
class FlairTemplateByBranchIndex(tdb_cassandra.Thing):
    """Lists of FlairTemplate IDs for a branch.
    ...
    flair templates within the branch.
    """
