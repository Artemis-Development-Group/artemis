...
class Email(object):
    ...
    subjects = {
        Kind.SHARE : _("[artemis] %(user)s has shared a link with you"),
        Kind.FEEDBACK : _("[feedback] feedback from '%(user)s'"),
        Kind.ADVERTISE :  _("[advertising] feedback from '%(user)s'"),
        Kind.OPTOUT : _("[artemis] email removal notice"),
        Kind.OPTIN  : _("[artemis] email addition notice"),
        Kind.RESET_PASSWORD : _("[artemis] reset your password"),
        Kind.VERIFY_EMAIL : _("[artemis] verify your email address"),
        Kind.BID_PROMO : _("[artemis] your budget has been accepted"),
        Kind.ACCEPT_PROMO : _("[artemis] your promotion has been accepted"),
        Kind.REJECT_PROMO : _("[artemis] your promotion has been rejected"),
        Kind.QUEUED_PROMO : _("[artemis] your promotion has been charged"),
        Kind.LIVE_PROMO   : _("[artemis] your promotion is now live"),
        Kind.FINISHED_PROMO : _("[artemis] your promotion has finished"),
        Kind.NEW_PROMO : _("[artemis] your promotion has been created"),
        Kind.EDITED_LIVE_PROMO : _("[artemis] your promotion edit is being approved"),
        Kind.NERDMAIL : _("[artemis] hey, nerd!"),
        Kind.GOLDMAIL : _("[artemis] artemis gold activation link"),
        Kind.PASSWORD_CHANGE : _("[artemis] your password has been changed"),
        Kind.EMAIL_CHANGE : _("[artemis] your email address has been changed"),
        Kind.REFUNDED_PROMO: _("[artemis] your campaign didn't get enough impressions"),
        Kind.VOID_PAYMENT: _("[artemis] your payment has been voided"),
        Kind.GOLD_GIFT_CODE: _("[artemis] your artemis gold gift code"),
        ...
        Kind.MESSAGE_NOTIFICATION: _("[artemis] message notification"),
        Kind.ADS_ALERT: _("[artemis] Ads Alert"),
        }
    ...
    def to_MIMEText(self):
        ...
        if not fr.startswith('-') and not self.to_addr.startswith('-'):
            ...
            if self.user:
                msg['X-Artemis-username'] = utf8(self.user.name)
            msg['X-Artemis-ID'] = self.msg_hash
            if self.reply_to:
