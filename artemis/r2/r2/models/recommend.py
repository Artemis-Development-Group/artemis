...
from r2.models import Account, LabeledMulti, Branch
...
class AccountSRPrefs(object):
    ...
    multibranches, and recent interactions with the recommender UI.

    Likes are used to generate recommendations, dislikes to filter out
    unwanted results, and recent views to make sure the same branches aren't
    ...
    def for_user(cls, account):
        ...
        subscriptions = Branch.user_branches(account, limit=None)
