...
from r2.models.branch import Frontpage
...
gold_table = sa.Table('artemis_gold', METADATA,
    ...
    if c.user_is_loggedin and thing.author_id == c.user._id:
        if isinstance(thing, Comment):
            gilded_message = ungettext(
                "a apollon gifted you a month of artemis gold for this "
                "comment.",
                "apollons have gifted you %(months)d months of artemis gold "
                "for this comment.",
                thing.gildings
            )
        else:
        ...
        if isinstance(thing, Comment):
            gilded_message = ungettext(
                "you have gifted artemis gold to %(recipient)s for this "
                "comment.",
                "you and other apollons have gifted %(months)d months of "
                "artemis gold to %(recipient)s for this comment.",
                thing.gildings
            )
        else:
            gilded_message = ungettext(
                ...
                "submission.",
                "you and other apollons have gifted %(months)d months of "
                "artemis gold to %(recipient)s for this submission.",
                thing.gildings
            )
    else:
        if isinstance(thing, Comment):
            gilded_message = ungettext(
                "a apollon has gifted artemis gold to %(recipient)s for this "
                "comment.",
                "apollons have gifted %(months)d months of artemis gold to "
...
def cbranches_lock(user):
    return g.make_lock("gold_cbranches", "cbranches_%s" % user._id)
