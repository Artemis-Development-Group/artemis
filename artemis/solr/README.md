## Solr Search Provider for Artemis

The Solr search provider lets you run Artemis's search on your own Solr server.
...
sudo ln -s /path/to/artemis/solr/schema.xml /usr/share/solr/conf
sudo service tomcat6 start
```

You should now be able to connect to Solr at http://127.0.0.1:8080

To configure artemis to use Solr for search, set the search provider to **solr**
in your .ini file:
