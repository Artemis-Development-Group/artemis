#!/usr/bin/env bash
###############################################################################
# artemis Drone environment installer
# ----------------------------------
...
# that Drone runs our builds within: https://github.com/artemis/docker-artemis-py
#
# docker-artemis-py has most of the apt dependencies pre-installed in order to
