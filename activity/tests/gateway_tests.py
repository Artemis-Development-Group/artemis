...
from artemis_service_activity.activity_thrift.ActivityService import Client
from artemis_service_activitygateway import ActivityGateway, make_wsgi_app
...
class GatewayFunctionalTests(unittest.TestCase):
    @mock.patch("artemis_service_activitygateway.ThriftConnectionPool")
    @mock.patch("artemis_service_activitygateway.make_metrics_client")
