...
import artemis_service_activity as activity
from artemis_service_activity.counter import ActivityCounter
from artemis_service_activity.activity_thrift import ActivityService
...
class ActivityServiceTests(unittest.TestCase):
    ...
    @mock.patch("artemis_service_activity.ActivityInfo", autospec=True)
    ...
    @mock.patch("artemis_service_activity.ActivityInfo", new=MockActivityInfo)
